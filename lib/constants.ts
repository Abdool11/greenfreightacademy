...
export const SITE_TAGLINE = "South Africa's specialist capability platform for the road freight sector";
...
export const NAV_LINKS = [
  ...
  { label: "Driver Search", href: "/registry" },
...
// ─── Hero ─────────────────────────────────────────────────────────────────────
export const HERO = {
  headline: "Road freight runs on people.",
  headlineGradient: "We develop the people who run road freight.",
  supporting:
...
export const PROGRAMMES: Programme[] = [
  ...
  },
  {
    ...
    audienceLabel: "Drivers",
    shortDescription:
      "A specialist programme preparing truck drivers for the transition to battery electric trucks — covering energy regeneration, range management, and EV safety.",
    fullDescription:
    ...
    outcomes: [
      "Understanding of electric drivetrain operation and battery management",
      "Regenerative braking techniques to extend range and reduce energy consumption",
      "High-voltage safety awareness and emergency response",
      "Correct charging procedures and pre-trip range planning",
    ...
    enrolments: [
      {
        ...
        programmeTitle: "Green Road Freight Management",
        status: "in-progress",
        progressPercent: 30,
