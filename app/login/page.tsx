    ...
    <div style={{ paddingTop: "5rem", background: "var(--color-slate-900)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <section style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "3rem 1.5rem", background: "linear-gradient(160deg, #0a1628 0%, #0f1f3d 100%)" }}>
        <div style={{ width: "100%", maxWidth: "440px", textAlign: "center" }}>
          <span className="pill-badge pill-green" style={{ marginBottom: "1.5rem", display: "inline-flex" }}>Company Login</span>
          <h1 style={{ marginBottom: "0.75rem" }}>Log in to your account</h1>
          <p style={{ color: "var(--text-secondary)", marginBottom: "2.5rem" }}>Access your dashboard, manage driver enrolments, and track training progress.</p>
