...
const eventTypes = new Set(["training_link_activated","training_started","module_completed","training_completed","briefing_delivered","briefing_acknowledged"]);
export async function POST(req: NextRequest) {
 ...
 if (eventType === "certificate_issued") return NextResponse.json({ error: "Certificate issue events must use the signed GFA certificate registry endpoint." }, { status: 410 });
