            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#0a1628] border border-slate-600 rounded-lg px-4 py-2.5 pr-11 text-white placeholder-slate-500 focus:outline-none focus:border-[#2ecc71] focus:ring-1 focus:ring-[#2ecc71] transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
