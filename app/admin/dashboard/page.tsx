        ...
        <aside className="w-56 min-h-[calc(100vh-65px)] bg-[#0d1a2e] border-r border-slate-700/50 py-6 px-3 flex-shrink-0">
          <nav className="space-y-1">
            {[
              ...
              { href: "/admin/settings/notifications", label: "Notifications", icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" },
              { href: "/admin/finance", label: "Finance & Ledger", icon: "M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" },
              { href: "/admin/operations", label: "Daily Operations", icon: "M8 7V3m8 4V3M7 11h10M5 5h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" },
              { href: "/admin/discounts", label: "Discount Approvals", icon: "M9 14l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 4.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9.25c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.031 9-11.622 0-.432-.023-.86-.068-1.282z" },
              ...
              { href: "/admin/settings/quote-profile", label: "Formal Quote Settings", icon: "M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM14 2v6h6M8 13h8M8 17h8" },
